...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ImmunizationEuHdr
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Immunization">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.eu/fhir/hdr/StructureDefinition/immunization-administeredProduct']) &lt;= 1">extension with URL = 'http://hl7.eu/fhir/hdr/StructureDefinition/immunization-administeredProduct': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
